      ...
      <div className="max-w-4xl mx-auto px-2">
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold">What are your fitness goals?</CardTitle>
            <CardDescription className="text-lg">Select all that apply - you can choose multiple goals!</CardDescription>
          </CardHeader>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {state.data.goals.map((goalId) => {
                      ...
                      return (
                        <Badge key={goalId} variant="secondary" className="text-sm">
            ...
            <Card className="bg-gradient-to-r from-primary/5 to-primary/10">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium mb-1">You're on the right track!</h4>
